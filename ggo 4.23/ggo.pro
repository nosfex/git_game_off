...
unrealRootPath=/home/gerardo/UE4/UnrealEngine-release
ggoRootPath=/home/gerardo/projects/git_game_off/ggo 4.23

gameProjectFile=/home/gerardo/projects/git_game_off/ggo 4.23/ggo.uproject
...
include(ggoSource.pri)
include(ggoHeader.pri)
include(ggoConfig.pri)
include(ggoIncludes.pri)
include(ggoDefines.pri)

ggo-Linux-Debug.commands = $$build ggo Linux Debug  -project="\"$$gameProjectFile\"" $$args
ggo-Linux-DebugGame.commands = $$build ggo Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
ggo-Linux-Shipping.commands = $$build ggo Linux Shipping  -project="\"$$gameProjectFile\"" $$args
ggo-Linux-Test.commands = $$build ggo Linux Test  -project="\"$$gameProjectFile\"" $$args
ggo.commands = $$build ggo Linux Development  -project="\"$$gameProjectFile\"" $$args

ggoEditor-Linux-Debug.commands = $$build ggoEditor Linux Debug  -project="\"$$gameProjectFile\"" $$args
ggoEditor-Linux-DebugGame.commands = $$build ggoEditor Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
ggoEditor-Linux-Shipping.commands = $$build ggoEditor Linux Shipping  -project="\"$$gameProjectFile\"" $$args
ggoEditor-Linux-Test.commands = $$build ggoEditor Linux Test  -project="\"$$gameProjectFile\"" $$args
ggoEditor.commands = $$build ggoEditor Linux Development  -project="\"$$gameProjectFile\"" $$args
...
QMAKE_EXTRA_TARGETS += \ 
	...
	ggo-Linux-Test \
	ggo \
	ggoEditor-Linux-Debug \
	ggoEditor-Linux-DebugGame \
	ggoEditor-Linux-Shipping \
	ggoEditor-Linux-Test \
	ggoEditor \
